<template>
  <div id="centerCallToAction">
    ...
    <div class="flex justify-between">
      <router-link
        class="w-full mr-1 py-2 px-4 bg-green-600 text-center text-white font-semibold text-2xl rounded-lg shadow-md hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 cursor-pointer"
        to="login"
      >
        Login
      </router-link>
      <router-link
        class="w-full mr-1 py-2 px-4 bg-blue-600 text-center text-white font-semibold text-2xl rounded-lg shadow-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 cursor-pointer"
        to="register"
      >
        Register
      </router-link>
